...
class AcquirerMercadopago(osv.Model):
    ...
    def _get_mercadopago_urls(self, cr, uid, environment, context=None):
        ...
        if environment == 'prod':
            return {
                ...
                'mercadopago_form_url': 'https://www.mercadopago.com/mlv/checkout/pay',
            ...
            return {
                ...
                'mercadopago_form_url': 'https://sandbox.mercadopago.com/mlv/checkout/pay',
    ...
    _columns = {
        ...
        'mercadopago_seller_account': fields.char('MercadoPago Merchant ID',
